...
const ImageGrid = () => {
  ...
  return (
    <>
      {openedIMage && (
        <>
          ...
          >
              ...
              <div className="flex">
                <div className="w-[875px] max-[1025px]:w-[575px] max-[769px]:w-[675px] flex flex-col gap-2.5 p-7.5">
                  ...
                  <div className="relative w-full h-[613px] max-[1025px]:h-[413px]">
                    ...
                    <div className="absolute bottom-3 right-3.75 pl-3.5 pr-3 pb-0.75 pt-1.25 text-[var(--Secondary-Teal)] bg-[var(--other-White)] opacity-90 font-bold leading-6 rounded-[30px]">
                      360°
                    </div>
                  </div>
            ...
            <div className="min-[376px]:hidden flex items-center">
      ...
      <div className="relative overflow-hidden max-w-360 mx-auto mb-15 max-[1441px]:mx-9.75 max-[376px]:m-0 max-[376px]:mb-5 grid grid-cols-5 gap-0.5 max-[769px]:flex max-[769px]:h-[553px] max-[376px]:h-[353px]">
